//
//  PunaTextFieldDefaultView.swift
//  PunaUI
//
...
class PunaTextFieldDefaultView: PunaTextFieldAbstractView {
    ...
    var currentVisibilities: [PunaTextFieldComponentVisibility] {
        return self.text.isEmpty ? [.always] : [.always, .whenNotEmpty]
    }

    override func loadNib() {
        let bundle = PunaBundle.bundle()
        bundle.loadNibNamed("PunaTextFieldDefaultView", owner: self, options: nil)
    ...
    func updateSideComponents() {
        let generatedLeftView: UIView? = PunaTextFieldComponentFactory.generateLeftComponentView(for: self.config, in: self, visibilities: self.currentVisibilities)
        let generatedRightView: UIView? = PunaTextFieldComponentFactory.generateRightComponentView(for: self.config, in: self, visibilities: self.currentVisibilities)
...
extension PunaTextFieldAbstractView: TextFieldDelegate {
