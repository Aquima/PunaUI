...
class PunaTextAreaView: PunaTextFieldAbstractView {
    @IBOutlet weak var textView: PunaUITextView!
    ...
    override func loadNib() {
        ...
        bundle.loadNibNamed("PunaTextAreaView", owner: self, options: nil)
    ...
    override func updateView() {
        super.updateView()
        placeholderLabel.setPunaStyle(style: config.placeholderStyle)
...
extension PunaTextAreaView: UITextViewDelegate {
