//
//  PunaTextFieldAccessibilityManager.swift
//  PunaUI
//
...
class PunaTextFieldAccessibilityManager: PunaAccessibilityManager {

    private weak var view: PunaTextField!
    ...
    required init(view: UIView) {
        guard let textField = view as? PunaTextField else {
            fatalError("TextField AccessibilityManager should recieve an PunaTextField")
        }
        self.view = textField
        viewUpdated()
    }
    ...
    private func createAccessibilityLabel(textField: PunaTextField) -> String {
    ...
    private func createLeftComponentAccessiblityText(_ leftComponent: PunaTextFieldLeftComponent?) -> String? {
...
private extension PunaTextFieldAccessibilityManager {
