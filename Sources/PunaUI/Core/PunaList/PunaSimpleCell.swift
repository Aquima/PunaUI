...
/**
 This class is a custom cell to PunaUI, this cell has a basic configuration
*/
public class PunaSimpleCell: PunaListCell {

    /**
     This method initialize an PunaSimpleCell to draw the row just objc
     - Parameters:
    ...
    */
    ...
    /**
     This method initialize an PunaSimpleCell to draw the row
     - Parameters:
       - title: Set the title for the cell
