...
@IBDesignable
internal class PunaCircularProgressBar: UIView {
    ...
    private func animateStroke() {
        ...
        let beginAnimation = PunaStrokeAnimation(
            type: .end,
            fromValue: 0.0,
            toValue: 0.75,
        ...
        let midAnimation = PunaStrokeAnimation(
            type: .start,
            beginTime: 0.75,
            fromValue: 0.0,
            toValue: 0.97,
        ...
        let endAnimation = PunaStrokeAnimation(
            type: .end,
            beginTime: 0.75,
            fromValue: 0.75,
            toValue: 1,
    ...
    private func animateRotation() {
        let rotationAnimation = PunaRotationAnimation(
            direction: .axisZ,
            fromValue: 0,
