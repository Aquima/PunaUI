...
class PunaDatePickerCell: UICollectionViewCell {

    // MARK: - Attributes

    static let identifier = String(describing: PunaDatePickerCell.self)
    ...
    private lazy var numberLabel: UILabel = {
        ...
        label.font = PunaStyleSheetManager.styleSheet.regularSystemFont(size: 14.0)
    ...
    private lazy var selectionBackgroundView: UIView = {
        ...
        view.backgroundColor = UIColor.Puna.blueMP500
    ...
    func applyDefaultStyle(isWithinDisplayedMonth: Bool) {
        ...
        numberLabel.textColor = isWithinDisplayedMonth ? PunaStyleSheetManager.styleSheet.textColorPrimary : PunaStyleSheetManager.styleSheet.textColorDisabled
